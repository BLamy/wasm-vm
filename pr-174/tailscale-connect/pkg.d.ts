declare global {
	...
	interface IPN {
		...
		dialTCP(host: string, port: number, timeoutMs?: number): Promise<IPNNetConn>;
		dialUDP(host: string, port: number, timeoutMs?: number): Promise<IPNNetConn>;
	}
	interface IPNNetConn {
