...
const clean = Object.fromEntries(Object.entries(process.env).filter(([k]) =>
  !k.startsWith('E5_') && !k.startsWith('CARGO_') && !['RUSTFLAGS', 'RUST_LOG'].includes(k)));
const config = { ...invocation.common, E5_T26F_DIAGNOSTIC: 'reuse', E5_T26F_DIAGNOSTIC_CPU: '1', E5_T26F_OUT: output };
