...
export function deriveAuditElided(sources, repo = repository) {
  ...
  const ramInstall = `eval "$(printf %s '${encodedPlay}'|base64 -d)";printf '\\033[2J\\033[H\\n\\n\\n\\n\\033[42me5t26f-audit-elided-ready\\033[0m\\n'`;
...
const milestones = { ...auditRecordLabel,`);
  ...
  return { source, changes, acceptance: false, fVerified: false, postIdentityValidated: false, auditRecordLabel,
    ...
    setupVisualChange: "clear-display-and-home plus four blank lines before audit-elided readiness marker; outside T0" };
}
