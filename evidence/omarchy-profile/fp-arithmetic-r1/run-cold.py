...
out=repo/'evidence/omarchy-profile/fp-arithmetic-r1/cold'
...
root=Path(tempfile.mkdtemp(prefix='wasm-vm-fp-arithmetic-cold-',dir='/private/tmp'))
clone=root/'repo'
...
try:
 ...
 run(['make','verify-E5_5-T03w','FP_ARITHMETIC_OUT='+str(out/'browser')],clone,'acceptance')
 receipt['passed']=True
finally:
 save()
