...
out=repo/'evidence/omarchy-profile/fp-to-word-r1/cold'
...
root=Path(tempfile.mkdtemp(prefix='wasm-vm-fp-to-word-cold-',dir='/private/tmp'))
clone=root/'repo'
...
try:
 ...
 run(['make','verify-E5_5-T03y','FP_TO_WORD_OUT='+str(out/'browser')],clone,'acceptance')
 receipt['passed']=True
finally:
 save()
