...
commands={
 ...
 'affected': [
  ...
  ('fp-regression',['cargo','test','-p','wasm-vm-jit-runtime','--test','fp_moves','--test','fp_memory','--test','precise_traps','--','--nocapture']),
  ...
  ('acceptance',['make','verify-E5_5-T03v','FP_COMPARISONS_OUT='+str(out/'acceptance-browser')]),
 ],
}[phase]
