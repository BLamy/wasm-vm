...
out=repo/'evidence/omarchy-profile/fp-memory-r1/cold'
...
root=Path(tempfile.mkdtemp(prefix='wasm-vm-fp-memory-cold-',dir='/private/tmp'))
clone=root/'repo'
...
try:
 ...
 run(['make','verify-E5_5-T03u','FP_MEMORY_OUT='+str(out/'browser')],clone,'acceptance')
 receipt['passed']=True
finally:
 save()
