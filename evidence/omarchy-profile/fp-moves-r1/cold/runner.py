...
repo=Path('/Users/blamy/Documents/Codex/wasm-vm')
out=repo/'evidence/omarchy-profile/fp-moves-r1/cold'
...
root=Path(tempfile.mkdtemp(prefix='wasm-vm-fp-moves-cold-',dir='/private/tmp'))
clone=root/'repo'
...
try:
 ...
 run(['make','verify-E5_5-T03t','FP_MOVES_OUT='+str(out/'browser')],clone,'acceptance')
 receipt['passed']=True
finally:
 save()
