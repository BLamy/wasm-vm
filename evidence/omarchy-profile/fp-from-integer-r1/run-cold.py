...
out=repo/'evidence/omarchy-profile/fp-from-integer-r1/cold'
...
root=Path(tempfile.mkdtemp(prefix='wasm-vm-fp-from-integer-cold-',dir='/private/tmp'))
clone=root/'repo'
...
try:
 ...
 run(['make','verify-E5_5-T03x','FP_FROM_INTEGER_OUT='+str(out/'browser')],clone,'acceptance')
 receipt['passed']=True
finally:
 save()
