...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Profile-gated browser-JIT entry timing", status: "in-progress", evidence: "E5-T22g: remove performance.now() sampling from normal compiled execution while retaining live structural counters; Chromium/Firefox worker parity and unchanged-v7 desktop timing are under verification." },
