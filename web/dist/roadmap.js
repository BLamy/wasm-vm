...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Monitor mode survives guest GPU reset", status: "in-progress", evidence: "E5-T22e: preserve browser-selected monitor state through Linux probe/reset while clearing guest resources. Independent reset proof in progress." },
