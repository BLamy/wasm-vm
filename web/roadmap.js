...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Live priority for pending JIT compilation", status: "in-progress", evidence: "E5-T26l: bounded refresh before selecting validated pending jobs; compilation budgets and F's two-second gate remain unchanged while real backlog and browser evidence are collected" },
