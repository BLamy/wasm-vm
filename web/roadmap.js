...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Config-gated virtio-snd microphone advertisement", status: "in-progress", evidence: "E5-T21b: creation-time enableMic gate and fixed 48 kHz INPUT metadata" },
