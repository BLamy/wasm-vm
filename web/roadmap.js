...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "User-mode network (slirp + smoltcp NAT)", status: "partial", evidence: "core done: ARP/ICMP + TCP flow/data path native-verified (E3-T14, #114–#120) — booted acceptance pending" },
    ],
  },
  {
    epic: "E3.5",
    ...
    caps: [
      ...
      { name: "Container matrix — pipeline is image-generic", status: "verified", evidence: "9/9 riscv64 images incl. postgres:18 (8483-entry bundle, RISC-V ELFs) (#110)" },
