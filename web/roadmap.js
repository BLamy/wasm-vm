...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "User-mode network (slirp + smoltcp NAT)", status: "verified", evidence: "browser Alpine DHCP + ping + byte-exact wget through WebSocket relay → real host TCP (E3-T14)" },
    ],
  },
  {
    epic: "E3.5",
