...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Omarchy full-screen desktop and fresh warm launch", status: "in-progress", evidence: "E5.5-T03c isolates coherent SDR snapshot rendering and host-side viewport fitting. Actual screenshot/reload evidence is required; E5.5-T03a/T03d remain blocked on slow physical input, and no responsive desktop or guest-modeset claim is made." },
