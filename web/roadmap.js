...
export const ROADMAP = [
  ...
  },
  {
    ...
    caps: [
      ...
      { name: "Bounded S/U cached-code permission work", status: "in-progress", evidence: "E5-T22f: measured resize prerequisite. Unchanged-PMP S/U transitions avoid redundant cache audits; M-mode and revision-revocation proofs are under test. No resize timing verdict yet." },
