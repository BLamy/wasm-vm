...
**7 / 188 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified

## Next up (deps satisfied, in priority order)

1. **E0-T08** — RV64I loads and stores with misaligned and access-fault trap semantics
1. **E0-T09** — Control flow — JAL, JALR, conditional branches, FENCE, and target-misalignment traps
1. **E0-T10** — ELF64 loader for bare-metal riscv64 executables
1. **E0-T12** — Stub MMIO console device for guest putchar output
1. **E0-T13** — Provision the riscv64 cross-toolchain, Spike, and QEMU with a reproducible Docker path
