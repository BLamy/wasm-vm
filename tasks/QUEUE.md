...
**18 / 188 tasks verified.**

Legend: `[ ]` pending · `[~]` in-progress · `[?]` implemented (awaiting adversarial verification) · `[!]` refuted · `[x]` verified

## Next up (deps satisfied, in priority order)

1. **E0-T19** — Run the riscv-tests rv64ui-p suite as a smoke gate with quarantined Zicsr stubs
1. **E0-T20** — Differential trace harness diffing our execution against Spike byte-for-byte
