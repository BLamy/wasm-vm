...
verify-E5-T26f:
	...
	node --test web/tests/e4-t32-worker-protocol.test.mjs web/tests/e5-t26e-desktop-restore.test.mjs web/tests/e5-t26f-desktop-agent-bridge.test.mjs web/tests/e5-t26f-readiness.test.mjs web/tests/agent-channel.test.mjs
	node --test tools/verify/e5-t26f-browser-roundtrip.test.mjs tools/verify/e5-t26f-cpu-profile.test.mjs
	$(MAKE) web-dist
