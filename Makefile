...
verify-E5-T26f:
	...
	node --test tools/verify/e5-t26f-browser-roundtrip.test.mjs tools/verify/e5-t26f-cpu-profile.test.mjs tools/verify/e5-t26f-residency-comparison.test.mjs
	$(MAKE) web-dist
