    ...
    fn browser_guest_sret_pending_ssip_guest_clear_variant() {
        ...
        for fixture in [&mut oracle, &mut jit] {
            encoded_block(
                &mut fixture.machine,
                SSIP_ARM,
                &[ADDI_X5_SSIP, CSRRS_SIP_X5, jal(SSIP_ARM + 8, OUTER)],
            );
            encoded_block(
                &mut fixture.machine,
                SSIP_HANDLER,
            ...
            assert_eq!(fixture.machine.hart().regs.pc, OUTER);
            assert_eq!(
                fixture.machine.hart_mut().csr.read(wasm_vm_core::csr::SIP) & SSIP,
                SSIP,
