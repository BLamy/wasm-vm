...
// E5-T09b: deterministic guest-side dirty-tile planner proof.  This slice freezes the core
// bitmap/plan seam; browser scheduling and DOM wiring belong to later T09 slices. Independent
// machines, WebKit, and host rr are excluded by the task policy and user scope.
...
const evidence = {
  schema: "wasm-vm.e5-t09b.dirty-tiles.v1",
  task: "E5-T09b",
  status,
  gitHead: gitHead(),
  commands: results,
