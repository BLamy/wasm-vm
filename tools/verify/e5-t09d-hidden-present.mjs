...
// E5-T09d: deterministic hidden-tab timer, visibility-resume, and vm.stats.gpu proof. The final
// guest workload belongs to E5-T09e; independent machines, WebKit, and host rr are outside scope.
...
const proofFiles = [
  ...
  "web/src/sink/visibility-scheduler.ts",
  "web/src/sink/presentation.js",
  "web/tests/e5-t09d-hidden-present.test.mjs",
  "tools/verify/e5-t09d-hidden-present.mjs",
];
...
const evidence = {
  schema: "wasm-vm.e5-t09d.hidden-present.v1",
  task: "E5-T09d",
