...
try {
  ...
  const quietCommand = "e5_print_observation(){ :; };printf '\\033[42mquiet-probe-ready\\033[0m\\n'";
  milestones.quietProbe = { acceptance: false, baselineRestore, baselineSnapshot: normalSnapshot,
    command: quietCommand, limitation: "RAM-only printer replacement; NOT the frozen installed helper or acceptance fixture" };
  ...
  milestones.quietProbe.preparation = await typeCommand(quietCommand, "quiet-probe-ready", 120_000, 100);
